 ...
 * [omia.yml](omia.yml)
     * Determines how your purl.obolibrary.org/obo/omia/ redirects will be handled
     ...
     * Paste in the contents of [omia.yml](omia.yml)
 ...
 * [omia.md](omia.md)
     ...
     * Paste in the contents of [omia.md](omia.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
