These notes are for the EDITORS of omia
...
Make sure you have an ID range in the [idranges file](omia-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [omia-edit.owl](omia-edit.owl)

** DO NOT EDIT omia.obo OR omia.owl in the top level directory **

[../../omia.owl](../../omia.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch/omia-ontology) for details.
 ...
 * [omia-idranges.owl](omia-idranges.owl)
...
This generates derived files such as omia.owl and omia.obo and places
 ...
 * https://github.com/monarch/omia-ontology/releases
 * https://github.com/monarch/omia-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived omia.owl (`data-version` in
omia.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/omia.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/omia/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch/omia-ontology.svg?branch=master)](https://travis-ci.org/monarch/omia-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/monarch](https://travis-ci.org/profile/monarch)
 2. click the "Sync account" button
 3. Click the tick symbol next to omia-ontology
